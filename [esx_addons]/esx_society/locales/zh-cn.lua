Locales['zh-cn'] = {
  ...
  ['uniform_management']     = '制服管理',
  ['uniform_all_grades']     = '所有职级',
  ['uniform_male']           = '男性',
  ['uniform_female']         = '女性',
  ['uniform_confirm_description'] = '将当前穿着保存为 %s 制服，职级：%s',
  ['uniform_saved']          = '制服已保存：%s',
  ['uniform_unchanged']      = '%s 的制服已是最新',
  ['uniform_failed']         = '制服保存失败',
  ['uniform_cooldown']       = '制服刚刚更新过，请在 %s 秒后重试',
  ['grade_label']            = '设置职称',
