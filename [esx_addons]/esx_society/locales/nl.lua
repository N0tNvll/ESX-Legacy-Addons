Locales['nl'] = {
  ...
  ['uniform_management']     = 'uniformbeheer',
  ['uniform_all_grades']     = 'alle rangen',
  ['uniform_male']           = 'man',
  ['uniform_female']         = 'vrouw',
  ['uniform_confirm_description'] = 'Sla de kleding die je draagt op als %s uniform voor: %s',
  ['uniform_saved']          = 'uniform opgeslagen voor: %s',
  ['uniform_unchanged']      = 'het uniform voor %s is al up-to-date',
  ['uniform_failed']         = 'het uniform kon niet worden opgeslagen',
  ['uniform_cooldown']       = 'uniformen zijn zojuist bijgewerkt, probeer het over %s seconden opnieuw',
