Locales['es'] = {
  ...
  ['uniform_management']     = 'gestión de uniformes',
  ['uniform_all_grades']     = 'todos los rangos',
  ['uniform_male']           = 'hombre',
  ['uniform_female']         = 'mujer',
  ['uniform_confirm_description'] = 'Guardar la ropa que llevas como uniforme %s para: %s',
  ['uniform_saved']          = 'uniforme guardado para: %s',
  ['uniform_unchanged']      = 'el uniforme para %s ya está actualizado',
  ['uniform_failed']         = 'no se pudo guardar el uniforme',
  ['uniform_cooldown']       = 'los uniformes se actualizaron hace poco, inténtalo de nuevo en %s segundos',
