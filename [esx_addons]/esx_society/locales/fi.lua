Locales['fi'] = {
  ...
  ['uniform_management']     = 'työasujen hallinta',
  ['uniform_all_grades']     = 'kaikki arvot',
  ['uniform_male']           = 'mies',
  ['uniform_female']         = 'nainen',
  ['uniform_confirm_description'] = 'Tallenna päälläsi oleva asu %s työasuksi: %s',
  ['uniform_saved']          = 'työasu tallennettu: %s',
  ['uniform_unchanged']      = 'työasu (%s) on jo ajan tasalla',
  ['uniform_failed']         = 'työasua ei voitu tallentaa',
  ['uniform_cooldown']       = 'työasut päivitettiin äskettäin, yritä uudelleen %s sekunnin kuluttua',
