Locales['it'] = {
  ...
  ['uniform_management']     = 'gestione divise',
  ['uniform_all_grades']     = 'tutti i gradi',
  ['uniform_male']           = 'uomo',
  ['uniform_female']         = 'donna',
  ['uniform_confirm_description'] = 'Salva la tenuta indossata come divisa %s per: %s',
  ['uniform_saved']          = 'divisa salvata per: %s',
  ['uniform_unchanged']      = 'la divisa per %s è già aggiornata',
  ['uniform_failed']         = 'impossibile salvare la divisa',
  ['uniform_cooldown']       = 'divise aggiornate da poco, riprova tra %s secondi',
