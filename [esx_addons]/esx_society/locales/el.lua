Locales['el'] = {
  ...
  ['uniform_management']     = 'διαχείριση στολών',
  ['uniform_all_grades']     = 'όλοι οι βαθμοί',
  ['uniform_male']           = 'ανδρική',
  ['uniform_female']         = 'γυναικεία',
  ['uniform_confirm_description'] = 'Αποθήκευση της ενδυμασίας που φοράς ως %s στολή για: %s',
  ['uniform_saved']          = 'η στολή αποθηκεύτηκε για: %s',
  ['uniform_unchanged']      = 'η στολή για %s είναι ήδη ενημερωμένη',
  ['uniform_failed']         = 'η στολή δεν ήταν δυνατό να αποθηκευτεί',
  ['uniform_cooldown']       = 'οι στολές ενημερώθηκαν πρόσφατα, δοκίμασε ξανά σε %s δευτερόλεπτα',
