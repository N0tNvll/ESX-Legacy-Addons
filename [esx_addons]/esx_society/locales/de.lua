Locales['de'] = {
  ...
  ['uniform_management']     = 'Uniformverwaltung',
  ['uniform_all_grades']     = 'alle Ränge',
  ['uniform_male']           = 'männlich',
  ['uniform_female']         = 'weiblich',
  ['uniform_confirm_description'] = 'Getragenes Outfit als %s Uniform speichern für: %s',
  ['uniform_saved']          = 'Uniform gespeichert für: %s',
  ['uniform_unchanged']      = 'die Uniform für %s ist bereits aktuell',
  ['uniform_failed']         = 'die Uniform konnte nicht gespeichert werden',
  ['uniform_cooldown']       = 'Uniformen wurden gerade aktualisiert, versuche es in %s Sekunden erneut',
