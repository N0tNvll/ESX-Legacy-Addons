Locales['fr'] = {
  ...
  ['uniform_management']     = 'gestion des tenues',
  ['uniform_all_grades']     = 'tous les grades',
  ['uniform_male']           = 'homme',
  ['uniform_female']         = 'femme',
  ['uniform_confirm_description'] = 'Enregistrer la tenue portée comme tenue %s pour : %s',
  ['uniform_saved']          = 'tenue enregistrée pour : %s',
  ['uniform_unchanged']      = 'la tenue pour %s est déjà à jour',
  ['uniform_failed']         = 'la tenue ne peut pas être enregistrée',
  ['uniform_cooldown']       = 'tenues mises à jour récemment, réessayez dans %s secondes',
