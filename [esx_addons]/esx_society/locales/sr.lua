Locales['sr'] = {
  ...
  ['uniform_management']     = 'upravljanje uniformama',
  ['uniform_all_grades']     = 'svi rangovi',
  ['uniform_male']           = 'muška',
  ['uniform_female']         = 'ženska',
  ['uniform_confirm_description'] = 'Sačuvaj odeću koju nosiš kao %s uniformu za: %s',
  ['uniform_saved']          = 'uniforma sačuvana za: %s',
  ['uniform_unchanged']      = 'uniforma za %s je već ažurna',
  ['uniform_failed']         = 'uniforma nije mogla biti sačuvana',
  ['uniform_cooldown']       = 'uniforme su nedavno ažurirane, pokušaj ponovo za %s sekundi',
