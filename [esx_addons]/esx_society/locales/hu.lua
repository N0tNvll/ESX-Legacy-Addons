Locales['hu'] = {
  ...
  ['uniform_management']     = 'egyenruha kezelés',
  ['uniform_all_grades']     = 'minden rang',
  ['uniform_male']           = 'férfi',
  ['uniform_female']         = 'női',
  ['uniform_confirm_description'] = 'A viselt ruházat mentése %s egyenruhaként ide: %s',
  ['uniform_saved']          = 'egyenruha mentve: %s',
  ['uniform_unchanged']      = 'az egyenruha (%s) már naprakész',
  ['uniform_failed']         = 'az egyenruhát nem sikerült menteni',
  ['uniform_cooldown']       = 'az egyenruhák nemrég frissültek, próbáld újra %s másodperc múlva',
