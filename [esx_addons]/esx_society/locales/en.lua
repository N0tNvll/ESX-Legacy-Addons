Locales['en'] = {
  ...
  ['uniform_all_grades']     = 'all grades',
  ['uniform_male']           = 'male',
  ['uniform_female']         = 'female',
  ['uniform_confirm_description'] = 'Save the outfit you are wearing as the %s uniform for: %s',
  ['uniform_saved']          = 'uniform saved for: %s',
  ['uniform_unchanged']      = 'uniform for %s is already up to date',
  ['uniform_failed']         = 'the uniform could not be saved',
  ['uniform_cooldown']       = 'uniforms were updated recently, try again in %s seconds',
