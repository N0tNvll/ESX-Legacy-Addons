Locales['cs'] = {
  ...
  ['uniform_management']     = 'správa uniforem',
  ['uniform_all_grades']     = 'všechny hodnosti',
  ['uniform_male']           = 'mužská',
  ['uniform_female']         = 'ženská',
  ['uniform_confirm_description'] = 'Uložit oblečení, které máš na sobě, jako %s uniformu pro: %s',
  ['uniform_saved']          = 'uniforma uložena pro: %s',
  ['uniform_unchanged']      = 'uniforma pro %s je již aktuální',
  ['uniform_failed']         = 'uniformu se nepodařilo uložit',
  ['uniform_cooldown']       = 'uniformy byly nedávno aktualizovány, zkus to znovu za %s sekund',
