...
INSERT INTO `job_grades` (job_name, grade, name, label, salary, skin_male, skin_female) VALUES
	('mechanic',0,'recrue','Novinec',12,@mechanic_skin_male,@mechanic_skin_female),
	('mechanic',1,'novice','Delavec',24,@mechanic_skin_male,@mechanic_skin_female),
	('mechanic',2,'experimente','Izkusen',36,@mechanic_skin_male,@mechanic_skin_female),
	('mechanic',3,'chief','Pod Direktor',48,@mechanic_skin_male,@mechanic_skin_female),
	('mechanic',4,'boss','Direktor',0,@mechanic_skin_male,@mechanic_skin_female)
;
